...
int main(void){
  ...
  Planeta[2].Inicie(x3, y3, 0, Vx3, Vy3, 0, m3, R3);

  for (t=0;t<tmax;t+=dt){

    cout<<Planeta[0].Getx()<<" "<<Planeta[0].Gety()<<" "<<Planeta[1].GetxRotado(omega, t)<<" "<<Planeta[1].GetyRotado(omega, t)<<" "<<Planeta[2].GetxRotado(omega, t)<<" "<<Planeta[2].GetyRotado(omega, t)<<endl;
